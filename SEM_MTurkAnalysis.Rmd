...
sem_decision[236,] = c("42406", 15, "Related", 0)
sem_decision[237,] = c("61558", 15, "Related", 0)
sem_decision[238,] = c("27113", 15, "Related", 0)
sem_decision[239,] = c("34686", 6, "Related", 0)
sem_decision[240,] = c("81385", 6, "Related", 0)
...
z_sem_rt_agg$zRT_trim = as.numeric(z_sem_rt_agg$zRT_trim)
...
# elp_model = lmer(data = new_sem_z, zRT_trim ~ mean_len + mean_logf +
#            (1|subject))
...
m3_linear = lmer(data = new_sem_z, zRT_trim~ pathlength +
            (1|subject) )
summary(m3_linear)
m3_quad = lmer(data = new_sem_z, zRT_trim ~ pathlength + I((pathlength)^2) +
            (1|subject) )
summary(m3_quad)
```
