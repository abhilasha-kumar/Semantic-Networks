...
primemask <- read.csv("S1_PrimeMask.csv", header=TRUE, sep= ",")
...
primenodata <- read.csv("S1_PrimeNO.csv", header=TRUE, sep= ",")
...
targetmask <- read.csv("S1_TargetMask.csv", header=TRUE, sep= ",")
...
targetnodata <- read.csv("S1_TargetNO.csv", header=TRUE, sep= ",")
...
write.csv(maskingaggregates, file = "S1_masks.csv")
