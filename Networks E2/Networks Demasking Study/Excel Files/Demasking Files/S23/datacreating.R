f = read.csv("S23_unscored.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
write.csv(f_primemask, file = "S23_PrimeMask.csv")
...
write.csv(f_primeno, file = "S23_PrimeNO.csv")
...
write.csv(f_targetmask, file = "S23_TargetMask.csv")
...
write.csv(f_targetno, file = "S23_TargetNO.csv")
