f = read.csv("S3_unscored.csv", header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
write.csv(f_primemask, file = "S3_PrimeMask.csv")
...
write.csv(f_primeno, file = "S3_PrimeNO.csv")
...
write.csv(f_targetmask, file = "S3_TargetMask.csv")
...
write.csv(f_targetno, file = "S3_TargetNO.csv")
